...
<p class="text">Our <a href='https://doi.org/10.1021/acsami.6c05214' target="_blank" style='color: #A1CF8D;'>collaborative paper</a> with Aristide Gumyuseng's group (MIT DMSE) on conductive polymers for electrochemical devices is now out in <em>ACS Applied Materials & Interfaces</em>!</p>
...
<p class="text">Shuwen led the organization of the workshop along with co-organizers Camille Bilodeau (UVA), Andrew Rosen (Princeton), Stefano Martiniani (NYU), and Juan de Pablo (NYU)! And she gave a talk on our exciting new work in uncertainty quantification and active learning algorithms for MLIPs! </p>
